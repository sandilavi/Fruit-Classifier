...
# Set parameters
IMAGE_SIZE = (224, 224)
REFERENCE_DIR = "step_2/dataset_2"  # Folder containing images for each class
...
with open("step_2/features_2.pkl", "wb") as f:
    pickle.dump(feature_dict, f)

print("Feature extraction complete. Saved to 'features_2.pkl'.")
